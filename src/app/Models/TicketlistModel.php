...
class TicketlistModel
{
    public function getTicketlist(){
        ...
        $pre=$pdo->prepare('
            ...
            JOIN user AS u ON o.fk_userid = u.userid
    ...
    public function newTicket(){
        $pdo=db();
        $userInsert=$pdo->prepare('INSERT INTO user(firstname, lastname, email, phone, fk_reductionid) VALUES ( :firstname, :lastname, :email, :phone, :reductionid)');
        ...
        $orderInsert=$pdo->prepare('INSERT INTO order(fk_userif, fk_concertid) VALUES (:userid, :concertid)');
